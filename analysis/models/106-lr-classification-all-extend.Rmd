---
title: "Logistic Regression Classification - Full, Extended"
...
### Export
```{r export_fit} 
outfile <- sprintf("tbl/%s-model-fit-lr-all-extend.xlsx", format(Sys.time(), '%Y%m%d'))
tidy(model) %>%
    arrange(p.value) %>%
    write_xlsx(outfile)
```
...
ggsave("img/extend/lr-all-coefs-all.pdf", width=6, height=8, dpi=300)
```
...
ggsave("img/extend/lr-all-pairs-tial1-tis11b.pdf", width=5, height=4, dpi=300)
```
...
ggsave("img/extend/lr-all-pairs-pumnum-tis11b.pdf", width=5, height=4, dpi=300)
```
...
ggsave("img/extend/lr-all-pairs-pum12rip-tis11b.pdf", width=5, height=4, dpi=300)
```
...
ggsave("img/extend/lr-all-pairs-pum12rip-tial1.pdf", width=5, height=4, dpi=300)
```
...
ggsave("img/extend/lr-all-pairs-pumnum-tial1.pdf", width=5, height=4, dpi=300)
```
...
ggsave("img/extend/lr-all-pairs-tis11b-larp4b.pdf", width=5, height=4, dpi=300)
```
...
ggsave("img/extend/lr-all-pairs-tia1l1-larp4b.pdf", width=5, height=4, dpi=300)
```
...
ggsave("img/extend/lr-all-pairs-mRNAlength-cdsexonavg.pdf", width=5, height=4, dpi=300)
```
...
ggsave("img/extend/lr-all-predict.pdf", width=5, height=5, dpi=300)
```
