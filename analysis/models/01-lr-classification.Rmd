...
### Export
```{r export_fit} 
outfile <- sprintf("tbl/%s-model-fit-lr.xlsx", format(Sys.time(), '%Y%m%d'))
tidy(model) %>%
    arrange(p.value) %>%
    write_xlsx(outfile)
```
...
ggsave("img/lr-coefs-all.pdf", width=6, height=8, dpi=300)
```
...
ggsave("img/lr-pairs-tial1-tis11b.pdf", width=5, height=4, dpi=300)
```
...
ggsave("img/lr-pairs-pumnum-tis11b.pdf", width=5, height=4, dpi=300)
```
...
ggsave("img/lr-pairs-pum12rip-tis11b.pdf", width=5, height=4, dpi=300)
```
...
ggsave("img/lr-pairs-pum12rip-tial1.pdf", width=5, height=4, dpi=300)
```
...
ggsave("img/lr-pairs-pumnum-tial1.pdf", width=5, height=4, dpi=300)
```
...
ggsave("img/lr-pairs-tis11b-larp4b.pdf", width=5, height=4, dpi=300)
```
...
ggsave("img/lr-pairs-tia1l1-larp4b.pdf", width=5, height=4, dpi=300)
```
...
ggsave("img/lr-predict-train.pdf", width=5, height=5, dpi=300)
...
ggsave("img/lr-predict-test.pdf", width=5, height=5, dpi=300)
```
