---
title: "Logistic Regression Classification with Interactions - Extended"
...
```{r data_impute}
df_imputed <- df_data %>%
    mutate_at(c("Anno_3UTR_length", "mane_mRNA_length", "mane_mean_cds_exon_length_all"), 
...
### Export
```{r export_fit} 
outfile <- sprintf("tbl/%s-model-fit-lr-interact-select-extend.xlsx", format(Sys.time(), '%Y%m%d'))
tidy(model) %>%
    arrange(p.value) %>%
    write_xlsx(outfile)
```
...
ggsave("img/extend/lr-interact-coefs-sig.pdf", width=6, height=6, dpi=300)
```
...
ggsave("img/extend/lr-interact-sig-coefs-tg-er.pdf", width=6, height=6, dpi=300)
...
ggsave("img/extend/lr-interact-sig-coefs-cy-er.pdf", width=6, height=6, dpi=300)
...
ggsave("img/extend/lr-interact-sig-coefs-tg-cy.pdf", width=6, height=6, dpi=300)
```
...
ggsave("img/extend/lr-interact-pairs-tial1-tis11b.pdf", width=5, height=4, dpi=300)
```
...
ggsave("img/extend/lr-interact-pairs-pumnum-tis11b.pdf", width=5, height=4, dpi=300)
```
...
ggsave("img/extend/lr-interact-pairs-pumnum-tial1.pdf", width=5, height=4, dpi=300)
```
...
ggsave("img/extend/lr-interact-pairs-hur-tis11b.pdf", width=5, height=4, dpi=300)
```
...
ggsave("img/extend/lr-interact-pairs-larp4b-tis11b.pdf", width=5, height=4, dpi=300)
```
...
ggsave("img/extend/lr-interact-pairs-pum12rip-tis11b.pdf", width=5, height=4, dpi=300)
```
...
ggsave("img/extend/lr-interact-pairs-pum12rip-tial1.pdf", width=5, height=4, dpi=300)
```
...
ggsave("img/extend/lr-interact-pairs-pum12rip-hur.pdf", width=5, height=4, dpi=300)
```
...
ggsave("img/extend/lr-interact-pairs-pumnum-fus.pdf", width=5, height=4, dpi=300)
```
...
ggsave("img/extend/lr-interact-pairs-mRNAlength-cdsexonavg.pdf", width=5, height=4, dpi=300)
```
...
ggsave("img/extend/lr-interact-predict-train.pdf", width=5, height=5, dpi=300)
...
ggsave("img/extend/lr-interact-predict-test.pdf", width=5, height=5, dpi=300)
```
